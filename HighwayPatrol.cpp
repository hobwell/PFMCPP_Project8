...
HighwayPatrol::HighwayPatrol() : Vehicle ("HighwayPatrol", "HighwayPatrol") {}
...
void HighwayPatrol::pullOver (Vehicle* const v, const bool willArrest, Highway* const h)
{
    std::cout << "\n\n";
    ...
    {       
        ...
        std::cout << name << ": YOU IN THE [ " << v->getVehicleType() << " ] PULL OVER AND SHOW YOUR HANDS" << std::endl;
